...
import ru.bikkul.parser.service.ProbitParserService;
...
@Slf4j
@RestController
@RequestMapping("${probit.api.prefix}" + "/parser")
@RequiredArgsConstructor
public class ProbitController {
    private final ProbitParserService parserService;
